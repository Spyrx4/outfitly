...
export default function AddProductPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Step 4: Insert product to database
      ...
      setForm({ name: '', category: '', shopee_link: '' })
      setImageFile(null)
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-16 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-black text-gray-800">Tambah Produk Baru</h1>
            <p className="text-xs text-gray-400">Isi form di bawah ini</p>
          </div>
        </div>
      </header>
